...
figure(5)
subplot(1,3,1);
nonlinear = svmtrain(x,y,'showplot',true,'kernel_function','rbf','rbf_sigma',0.1);legend('sigma=0.1');
subplot(1,3,2);
nonlinear = svmtrain(x,y,'showplot',true,'kernel_function','rbf','rbf_sigma',1);legend('sigma=1');
subplot(1,3,3);
nonlinear = svmtrain(x,y,'showplot',true,'kernel_function','rbf','rbf_sigma',10);legend('sigma=10');
